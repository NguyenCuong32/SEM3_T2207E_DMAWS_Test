...
namespace DMAWS_Test.Controllers
{
    ...
    public class OrderTblsController : ControllerBase
    {
        ...
        public OrderTblsController(OrderSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderTbl>> PostOrderTbl(OrderTbl orderTbl)
        {
          if (_context.OrderTbl == null)
          {
              return Problem("Entity set 'OrderSystemContext.OrderTbl'  is null.");
          }
